...
PLUGIN_ENTRY_POINT = 'neon_utterance_zeroshot_clf_plugin=neon_utterance_zeroshot_clf_plugin:TarsZeroShotClassifier'
setup(
    name='neon_utterance_zeroshot_clf_plugin',
    version='0.0.1',
    ...
    license='bsd3',
    packages=['neon_utterance_zeroshot_clf_plugin'],
    zip_safe=True,
